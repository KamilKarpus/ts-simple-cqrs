...
import {
  CommandBaseHandler,
  CommandBaseHandlerWithResponse,
  QueryBaseHandler,
} from "../src/models/request-handler-interface";
...
export class TestRequestHandler
  implements CommandBaseHandlerWithResponse<TestRequest, TestResponse> {
...
export class TestQueryHandler
  implements QueryBaseHandler<TestQuery, TestResponse> {
...
export class QueryWithInjectedServiceHandler
  implements QueryBaseHandler<QueryWithInjectedService, ServiceResponse> {
...
export class RequestHandlerWithoutDecorator
  implements CommandBaseHandler<VoidCommand> {
  handle(request: VoidCommand): Promise<void> {
    throw new Error("Method not implemented.");
  }
}

export class RequestWithoutHandler {}
